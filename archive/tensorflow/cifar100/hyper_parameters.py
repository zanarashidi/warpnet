...
tf.app.flags.DEFINE_string('version', 'results_c6termswithinputsonce', '''A version number defining the directory to save
logs and checkpoints''')
#default report_freq is 391
...
time''')
tf.app.flags.DEFINE_integer('decay_step0', 23460, '''At which step to decay the learning rate''')
tf.app.flags.DEFINE_integer('decay_step1', 46920, '''At which step to decay the learning rate''')
tf.app.flags.DEFINE_integer('decay_step2', 62560, '''At which step to decay the learning rate''')


## The following flags define hyper-parameters modifying the training network

tf.app.flags.DEFINE_integer('num_residual_blocks', 4, '''How many residual blocks do you want''')
...
tf.app.flags.DEFINE_string('ckpt_path', 'logs_test_results_cifar10_fixed_N3_k4/model.ckpt-79999', '''Checkpoint
directory to restore''')
tf.app.flags.DEFINE_boolean('is_use_ckpt', False , '''Whether to load a checkpoint and continue
training''')

tf.app.flags.DEFINE_string('test_ckpt_path', 'logs_test_results_cifar10_fixed_2/model.ckpt-79999', '''Checkpoint
directory to restore''')
